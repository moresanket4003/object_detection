...
#image=cv2.imread("config_files/sanket.jpg")
#image=cv2.imread("config_files/iphone.webp")
#image=cv2.imread("config_files/train.jpg")
#image=cv2.imread("config_files/knife1.webp")
#image=cv2.imread("config_files/traffic_signal.jpg")
image=cv2.imread("config_files/scisors.jpg")
